    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b><img src="{{asset('img/V20.png')}}" height="20px" width="45px"></b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><img src="{{asset('img/V20.png')}}" height="50px" width="200px"></b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header"></li>
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('escuela/categoria')}}"><i class="fa fa-circle-o"></i> Categorias</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('escuela/ficha')}}"><i class="fa fa-circle-o"></i>Estudiante</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('escuela/funcionario')}}"><i class="fa fa-circle-o"></i> Usuarios</a></li>
