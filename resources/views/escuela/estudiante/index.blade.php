...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		@include ('escuela.estudiante.search')		
	</div>
</div>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				@foreach ($estudiantes as $est)
				 <tr>
					 ...
					 <td>
						 <a href=" {{URL::action('EstudianteController@edit',$est->no_documento)}}"><button class="btn btn-info">Editar</button></a>
						 <a href="" data-target="#modal-delete-{{$est->no_documento}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>
					 </td>
				 </tr>
				@include('escuela.estudiante.modal')
				@endforeach 
			</table>			
		</div>	
